...
static char s[256];
static const char strName[] = "GYROSENSOR_EV3";
static uint8_t sn_gyro;
...
static const HALPROPERTY_T gyrosensor_ev3_property = {
	(char *)strName,
	(char **)strFncLst,
...
static HALRETURNCODE_T fncGetProperty(HALCOMPONENT_T *pHalComponent,HAL_ARGUMENT_T *pCmd) {
	pHalComponent->property = (HALPROPERTY_T *)&gyrosensor_ev3_property;
	return HAL_OK;
}
...
HAL_FNCTBL_T HalGyroSensorEV3Tbl = {
		fncInit,
		fncReInit,
		fncFinalize,
		fncAddObserver,
